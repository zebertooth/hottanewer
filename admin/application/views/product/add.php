            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">เพิ่มสินค้า</h4>
...
<?php
echo'
<form id="form_order" method="POST" class="form-horizontal" role="form" action="../product/complete" enctype="multipart/form-data">
    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="brand_TH" name="brand_TH" class="required form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Brand English</label>
                                    <div class="col-md-9">
                                        <input type="text" id="brand_EN" name="brand_EN" class="required form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">URL</label>
                                    <div class="col-md-9">
                                        <input type="text" id="urllink" name="urllink" class="required form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Name Thai</label>
                                    <div class="col-md-9">
                                        <input type="text" id="shortth_name" name="shortth_name" class="required form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Name Eng</label>
                                    <div class="col-md-9">
                                        <input type="text" id="shorten_name" name="shorten_name" class="required form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
 <textarea class="form-control"  id="short_descriptionEN"   name="short_descriptionEN" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
 <textarea class="form-control"  id="short_descriptionTH"   name="short_descriptionTH" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
...
echo' </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
 <textarea class="form-control"  id="detail_sec1"   name="detail_sec1" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Description Section 2</label>
                                    <div class="col-md-9">
 <textarea class="form-control"  id="detail_sec2"   name="detail_sec2" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
