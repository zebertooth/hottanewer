 ...
 <input type="file"  name ="picture" id="picture">
  <input type="hidden"  name ="picture2" id="picture2" value='.$row->pic.'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
 <textarea class="form-control"  id="topic"   name="topic" rows="4" cols="50">'.$row->title.'</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">หัวข้อ</label>
                                    <div class="col-md-9">
 <textarea class="form-control"  id="topic"   name="topic" rows="4" cols="50">'.$row->intro.'</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
