<form method="POST" action="<?php echo site_url('topup/bank_drawing_check'); ?>" class="form-horizontal" role="form">

	<input  type="hidden" name="id" value="<?php echo $r->drawing_id; ?>" />
