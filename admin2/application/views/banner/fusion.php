            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">หน้า</h4> &nbsp; &nbsp; <a href="<?php echo site_url('banner/add/2'); ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="เพิ่ม">เพิ่มข้อมูล</a>
