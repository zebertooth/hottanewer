                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="enname" name="enname" class="required form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3" for="disabledTextInput">Subname En</label>
                                    <div class="col-md-9">
 <textarea class="form-control"  id="sub_nameUE"   name="sub_nameUE" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
 <textarea class="form-control"  id="sub_nameUTH"   name="sub_nameUTH" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
