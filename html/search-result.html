    ...
    <main>
        ...
        <section class="py-5 px-lg-5">
            <div class="container">
                ...
                <div class="row pt-5">
                    <div class="col-12">
                        <h2 class="text-primary-2 text-center">
                            สินค้า ฮอทต้า ฟิวชั่น
                        </h2>
                    </div>
        ...
        <section class="bg-grey py-5">
            <div class="container-fluid px-30">
                <h2 class="text-center text-primary-2">
                    ข่าวสารและบทความ
                </h2>
                <div class="grid -d4">
                        ...
                        <a href="content-product.html" class="d-flex flex-column  h-100">
                            ...
                            <div class="d-flex flex-fill flex-column justify-content-between"> 
                                <div class="blog-content">
                                    ...
                                    <h3 class="topic">
                                        4 วิธีคลายร้อนง่าย ๆ กินให้สุขภาพดี
                                    </h3>
                                </div>
                                <div class="blog-link">
                                    <button>
                    ...
                    <article class="card -blog _desktop">
                        <a href="content-product.html" class="d-flex flex-column  h-100">
                            <div class="pic">
                                <picture>
                                    <source srcset="./img/blog3.webp" type="image/webp">
