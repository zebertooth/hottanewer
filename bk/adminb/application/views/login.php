            ...
            <div class="auth-box bg-dark border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                          <span class="db"><img src="<?php echo base_url(); ?>items/template/assets/images/logo-text.png" alt="logo" style="width:130px" /></span>
                    </div>
                    <!-- Form -->
<form method="post" class="form-signin form-horizontal m-t-20">
 <?php echo (isset($msg)?'<div class="alert alert-warning">'.$msg.'</div>':''); ?>
              ...
              <!----   <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button>--->
                                        <button class="btn btn-success btn-block btn-lg" type="submit">เข้าสู่ระบบ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
