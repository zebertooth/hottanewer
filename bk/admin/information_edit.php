...
<form action="controllers/news_controller.php" method="post" enctype="multipart/form-data" name="form_edit" id="form_edit">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="d-none">
        ...
        <tr>
            ...
            <td height="30" valign="top"><label for="pic1"></label> <input name="pic1" type="file" id="pic1" size="40" /><span class="remark">ขนาดความกว้างไม่เกิน
                    900 pixel</span></td>
        </tr>
        ...
        <tr>
            ...
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><label for="pic3"></label> <input name="pic3" type="file" id="pic3" size="40" /> <span class="remark">ขนาดความกว้างไม่เกิน
                    900 pixel</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><label for="pic5"></label> <input name="pic5" type="file" id="pic5" size="40" /> <span class="remark">ขนาดความกว้างไม่เกิน
                    900 pixel</span></td>
        </tr>
        <tr>
            <td align="right" valign="top" nowrap="nowrap"><strong>รายละเอียดที่
        ...
        <tr>
            <td height="30" align="right" valign="top" nowrap="nowrap"><strong>เอกสารแนบ
                    1 </strong></td>
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><label for="attach1"></label> <input name="attach1" type="file" id="attach1" size="40" /> <span class="remark">ขนาดไฟล์ไม่เกิน 2 MB</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><label for="attach2"></label> <input name="attach2" type="file" id="attach2" size="40" /> <span class="remark">ขนาดไฟล์ไม่เกิน 2 MB</span></td>
        </tr>
        <tr>
            <td align="right" valign="top" nowrap="nowrap"><strong>ชื่อเอกสารแนบ
                    3</strong></td>
        ...
        <tr>
            ...
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><label for="attach3"></label> <input name="attach3" type="file" id="attach3" size="40" /> <span class="remark"> ขนาดไฟล์ไม่เกิน 2 MB</span></td>
        </tr>
        ...
        <tr>
            ...
            <td height="30" align="center" valign="top"><strong>:</strong></td>
            <td height="30" valign="top"><span id="btnLinkProduct"> <img src="images/icon_add.png" alt="ทำการเพิ่ม link ข้อมูลสินค้า" align="absmiddle" /> เพิ่มการ Link ข้อมูลสินค้า
                </span>
