        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header py-3">
                    <h1 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-image"></i>Create Banner</h1>
                </div>
                <div class="card-body">

                    <div class="col-lg-6">
                        <form role="form" action="controllers/carousel_controller.php" method="post"
                            enctype="multipart/form-data" name="form_add" id="form_add">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="banner" id="banner" class="form-control form-control-input"
                                    ng-model="PostBanner" required>
                                <span style="color:red; font-weight: bold;"
                                    ng-show="form_add.PostBanner.$error.required">Required</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="type" id="radio"
                                            value="picture" checked='checked' />Picture</label>
