...
$sql = new SQLManager();
$sql->field = "product.*,
                            mall_product.status_new,
                            mall_product.status_recommend,
                            mall_product.status_bestseller,
                            mall_product.show_web,
                            mall_product.group_id,
                            mall_product.subgroup_id";
$sql->table = "tbl_product AS product
                        LEFT JOIN product AS mall_product ON product.oid = mall_product.id";
$sql->condition = "WHERE product.oid = ".GetSQLValueString($_GET['id'], "int");
$rs = $sql->select();
...
$sql->condition = "ORDER BY name ASC";
$rsGroup = $sql->select ();



$arrIncCss = array("UI" => "../css/blitzer/jquery-ui.css");
$arrIncScript = array(
					"UI" => "../js/jquery-ui.js",
					"tinybrowser" => "plugins/tiny_mce/plugins/tinybrowser/tb_tinymce.js.php",
					"pluginstinymce" => "plugins/tiny_mce/jquery.tinymce.js",
					"tinymce" => "js/tiny_mce.js",
                    "product" => "js/product_edit.js"
				);
?>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header py-3">
                    <h1 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-image"></i>Edit Product</h1>
                </div>
                <div class="card-body">

                    <div class="col-lg-12">
                        <form role="form" action="controllers/product_controller.php" method="post"
                            enctype="multipart/form-data" name="form_edit" id="form_edit">

                            <div class="form-group">
                                <label for="postLink">Product Name</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder=""
                                    value="<?php echo $row['productname']; ?>" ng-model="PostName" required>
                                <span style="color:red; font-weight: bold;"
                                    ng-show="form_edit.PostName.$error.required">Required</span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" id="name_en" class="form-control" placeholder=""
                                    value="<?php echo $row['productnameen']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="postLink">Brand</label>
                                <input type="text" name="brand" id="brand" class="form-control" placeholder=""
                                    value="<?php echo $row['brandname']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="postLink">Brand English</label>
                                <input type="text" name="branden" id="branden" class="form-control" placeholder=""
                                    value="<?php echo $row['brandnameen']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="postLink">URL</label>
                                <input type="text" name="url" id="url" class="form-control" placeholder="" value="<?php echo $row['url']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="model" id="model" value="instant" <?php if($row['model'] == "instant") echo 'checked="checked"'; ?> />Instant</label>

                                    <label class="radio-inline"><input type="radio" name="model" id="model2" value="ready" <?php if($row['model'] == "ready") echo 'checked="checked"'; ?> />Ready to drink</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="postLink">Short Description</label>
                                <textarea type="text" name="intro" id="intro" class="form-control"
                                    placeholder=""><?php echo $row['shortdesc']; ?></textarea>
                            </div>


                            <div class="form-group">
                                <label for="postLink">Short Description Engish</label>
                                <textarea type="text" name="intro_en" id="intro_en" class="form-control"
                                    placeholder=""><?php echo $row['shortdescen']; ?></textarea>
                            </div>


                            <div class="form-group">
                                <label for="PostThumb">Thumbnail Picture</label> <span style="color:red;">(Width size : 1000 pixel)</span>
                                <input type="file" name="thumb" id="thumb" class="form-control form-control-input">
                                <?php if(!empty($row['thumbnailimage'])) : ?>
                                <a href="../<?php echo $row['thumbnailimage']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                            ...
                            <div class="form-group d-none">
                                <label for="PostThumben">Thumbnail Picture English</label> <span
                                    style="color:red;">(Width size : 1000 pixel)</span>
                                <input type="file" name="thumb_en" id="thumb_en"
                                    class="form-control form-control-input ">
                                <?php if(!empty($row['thumbnailimageen'])) : ?>
                                <a href="../<?php echo $row['thumbnailimageen']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                                    <i class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group d-none">
                                ...
                                <input type="text" name="group" id="group" class="form-control" placeholder=""
                                    value="0">
                            </div>

                            <div class="form-group d-none">
                                <label for="postLink">Sub Group</label>
                                <input type="text" name="subgroup" id="subgroup" class="form-control" placeholder=""
                                    value="0">
                            </div>

                            <div class="form-group">
                                <label for="PostPic1">Picture Show</label> <span style="color:red;">Width size : 1000 pixel)</span>
                                <input type="file" name="pic1" id="pic1" class="form-control form-control-input">
                                <?php if(!empty($row['fullimage1'])) : ?>
                                <a href="../<?php echo $row['fullimage']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                                    <i class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="pic2" id="pic2" class="form-control form-control-input"
                                    >
                                    <?php if(!empty($row['fullimage1'])) : ?>
                                <a href="../<?php echo $row['fullimage1']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                                    <i class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="detail1" rows="5" id="detail1"
                                    ng-model="PostDetail" required><?php echo $row['description']; ?></textarea></td>
                                <span style="color:red; font-weight: bold;"
                                    ng-show="form_edit.PostDetail.$error.required">Required</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if(!empty($row['fullimage2'])) : ?>
                                <a href="../<?php echo $row['fullimage2']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                                    <i class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            ...
                            <div class="form-group ">
                                ...
                                <textarea class="form-control" name="detail2" rows="5" id="detail2"><?php echo $row['description1']; ?></textarea></td>
                            ...
                            <div class="form-group ">
                                ...
                                <?php if(!empty($row['fullimage3'])) : ?>
                                <a href="../<?php echo $row['fullimage3']; ?>" rel="shadowbox[product]"
                                    class="shadowbox" title="Product (Thumbnail)" target="blank">
                                    <i class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group ">
                                <label for="PostDetail3">Description Section 2</label>
                                <textarea class="form-control" name="detail3" rows="5" id="detail3"><?php echo $row['description2']; ?></textarea></td>
                            ...
                            <div class="form-group d-none">
                                <label for="PostDetail4">Description Section 3</label>
                                <textarea class="form-control" name="detail4" rows="5" id="detail4"><?php echo $row['description3']; ?></textarea></td>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="product_new" id="radio"
                                            value="Y" <?php if($row['status_new'] == "Y") echo 'checked="checked"'; ?> />Yes</label>

                                    <label class="radio-inline"><input type="radio" name="product_new" id="radio2"
                                            value="N" <?php if($row['status_new'] == "N") echo 'checked="checked"'; ?>/>No</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="product_reccommend" id="radio"
                                            value="Y" <?php if($row['status_recommend'] == "Y") echo 'checked="checked"'; ?> />Yes</label>

                                    <label class="radio-inline"><input type="radio" name="product_reccommend"
                                            id="radio2" value="N" <?php if($row['status_recommend'] == "N") echo 'checked="checked"'; ?>/>No</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="product_bestsell" id="radio"
                                            value="Y" <?php if($row['status_bestseller'] == "Y") echo 'checked="checked"'; ?> />Yes</label>

                                    <label class="radio-inline"><input type="radio" name="product_bestsell" id="radio2"
                                            value="N"<?php if($row['status_bestseller'] == "N") echo 'checked="checked"'; ?> />No</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="status" id="radio" value="Y"
                                    <?php if($row['show_web'] == "Y") echo 'checked="checked"'; ?> />Show</label>

                                    <label class="radio-inline"><input type="radio" name="status" id="radio2"
                                            value="N" <?php if($row['show_web'] == "N") echo 'checked="checked"'; ?>/>No show</label>
                                </div>
                            ...
                            <hr>
                            <div class="form-group">
                                <input class="btn btn-info" type="submit" name="btn_edit" id="btn_edit" value="Save"
                                    ng-disabled="form_edit.$invalid" />
                                <input class="btn btn-info" type="reset" name="btn_reset" id="btn_reset"
                                    value="Cancel" />
                                    <input type="hidden" name="id" id="id" value="<?php echo $row['oid']; ?>" />  
...
$(document).ready(function() {
    ...
    $('#editor1,#editor2').each(function(index, element) {
        $(element).wysiwyg({
