        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header py-3">
                    <h1 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-image"></i>Edit Banner</h1>
                </div>
                <div class="card-body">

                    <div class="col-lg-6">
                        <form role="form" action="controllers/banner_controller.php" method="post"
                            enctype="multipart/form-data" name="form_edit" id="form_edit">


                            <div class="form-group">
                                <label for="PostBanner">Banner Picture</label> <span style="color:red;">(Width Size : 2700 pixel)</span>
                                <input type="file" name="banner" id="banner" class="form-control form-control-input"
                                    ng-model="PostBanner">
                                <?php if(!empty($row['banner']) && file_exists("../upload/banner/".$row['banner'])) : ?>
                                <input name="del_banner" type="checkbox" id="del_banner" value="thumbs" />
                                <strong>Remove Picture</strong>
                                <a href="../upload/banner/<?php echo $row['banner']; ?>" target="_blank"><i
                                        class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            ...
                            <div class="form-group ">
                                <label for="PostThumb">Banner Mobile Picture</label> <span style="color:red;">(Width Size : 900 pixel)</span>
