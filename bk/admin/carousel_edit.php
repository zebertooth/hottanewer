...
$arrIncCss = array("shadowbox" => "../plugins/shadowbox/shadowbox.css");
$arrIncScript = array("shadowbox" => "../plugins/shadowbox/shadowbox.js",
		"banner" => "js/banner_edit.js");
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header py-3">
                    <h1 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-image"></i>Edit Fusion Time</h1>
                </div>
                <div class="card-body">

                    <div class="col-lg-6">
                        <form role="form" action="controllers/carousel_controller.php" method="post"
                            enctype="multipart/form-data" name="form_edit" id="form_edit">


                            <div class="form-group">
                                <label for="PostBanner">Banner Picture</label> <span style="color:red;">(Size : 1280 *
                                1280 pixel)</span>
                                <input type="file" name="banner" id="banner" class="form-control form-control-input"
                                     >
                                     <?php if(!empty($row['banner']) && file_exists("../upload/carousel/".$row['type']."/".$row['banner'])) : ?>
                                <input name="del_banner" type="checkbox" id="del_banner" value="thumbs" />
                                <strong>Remove Picture</strong>
                                <a href="../upload/carousel/<?php echo $row['type']."/".$row['banner']; ?>" target="_blank"><i
                                        class="fa fa-eye "></i></a>
                                <?php endif; ?>
                            ...
                            <div class="form-group d-none">
                                <label for="PostThumb">Banner Picture</label> <span style="color:red;">(Size : 1280 *
                                1280 pixel)</span>
                                <input type="file" name="banner_en" id="banner_en"
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="type" id="radio"
                                            value="picture" <?php if($row['type'] == 'picture'){	echo "checked = 'checked' ";}?> />Picture</label>

                                    <label class="radio-inline"><input type="radio" name="type" id="radio2"
                                            value="video" <?php if($row['type'] == 'video'){	echo "checked = 'checked' ";}?> />Video</label>
                                </div>

                            </div>

                            <div class="form-group">
                                <label for="postLink">Caption</label>
                                <input type="text" name="caption" id="caption" class="form-control" placeholder="" value="<?php echo $row['caption'];?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="link" id="link" class="form-control" placeholder="" value="<?php echo $row['link'];?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="statusShow" id="radio"
                                            value="1" <?php if($row['show_web'] == '1'){	echo "checked = 'checked' ";}?> />Show</label>

                                    <label class="radio-inline"><input type="radio" name="statusShow" id="radio2"
                                            value="0" <?php if($row['show_web'] == '0'){	echo "checked = 'checked' ";}?>/>No show</label>
                                </div>
                            ...
                            <hr>
                            <div class="form-group">
                                <input class="btn btn-info" type="submit" name="btn_add" id="btn_add" value="Save"
                                    ng-disabled="form_add.$invalid" />
                                <input class="btn btn-info" type="reset" name="btn_reset" id="btn_reset"
                                    value="Cancel" />
                                    <input type="hidden" name="hid_type" id="" value="edit" />
                                <input type="hidden" name="hid_id" id="" value="<?php echo $row['id']?>" />
                            </div>
