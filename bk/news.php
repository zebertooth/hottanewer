...
$sql->condition = "where show_web = 1 and type = 'news'  " . $subtype . " order by id DESC limit 3";
...
$sql->condition = "where show_web = 1 and type = 'news' " . $subtype . " order by id DESC limit 6";
...
$split->table = "news";
$split->condition = "WHERE type='news' " . $subtype . "  ORDER BY id DESC";
$rs = $split->startRow ();
                            ...
                            ?>
                                    ...
                                    <div class="swiper-slide bg-grey">
                                        <article class="card -hero">
                                            <a href="content.php?id=<?php echo $row->id; ?>" class="d-flex flex-column">
                                                <div class="pic">
                        ...
                        <div class="category-filter">
                            ...
                            <div class="dropdown filter-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="news.php" >ทั้งหมด</a>
                                  <a class="dropdown-item" href="news.php?subtype=video" >Video</a>
                                  <a class="dropdown-item" href="news.php?subtype=news">News</a>
                                  <a class="dropdown-item" href="news.php?subtype=activity" >Activity</a>
                                </div>
                              </div>
                        </div>
                    </div>
                        ...
                        <article class="card -blog">
                            <a href="content.php?id=<?php echo $row->id; ?>" class="d-flex flex-column  h-100">
                                ...
                                <div class="d-flex flex-fill flex-column justify-content-between">
                                    <div class="blog-content">
                                        <div class="category">
                                            <span class="category-item"><?php echo $row->subtype ; ?>
                                                                       </span>
                                        </div>
                                        <h3 class="topic">
                                            <?php echo $row->title; ?>
